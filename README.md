...
-   **Architecture Validation**: mcb-validate crate, Phases 1–7 (CA001–CA009, metrics, duplication); 2910+ tests project-wide
...
2910+ tests covering all layers:
...
-   **mcb-validate**: Architecture validation (Phases 1–7, 2910+ tests)
