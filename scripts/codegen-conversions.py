...
EntityConfig = TypedDict(
    "EntityConfig",
    {
        ...
        "entity": str,
        "fields": list[str],
        "extra_imports": NotRequired[list[str]],
        "not_set": NotRequired[list[str]],
        "convert": NotRequired[dict[str, ConverterConfig]],
    },
)
...
def all_fields_ordered(entity: EntityConfig) -> list[str]:
...
def gen_conversion_file(name: str, entity: EntityConfig) -> str:
    domain_type = entity["domain"]
    entity_module = entity["entity"]
