...
#[fixture]
fn tracker() -> std::sync::Arc<dyn IndexingOperationsInterface> {
    resolve_indexing_operations_provider(&IndexingOperationsProviderConfig::new("default"))
        .expect("indexing operations provider should resolve")
}
...
fn test_indexing_operations_lifecycle(
    tracker: std::sync::Arc<dyn IndexingOperationsInterface>,
...
#[rstest]
fn test_indexing_operations_multiple(tracker: std::sync::Arc<dyn IndexingOperationsInterface>) {
