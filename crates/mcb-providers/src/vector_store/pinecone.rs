...
use crate::constants::{
    ...
    PROVIDER_RETRY_BACKOFF_MS, PROVIDER_RETRY_COUNT, STATS_FIELD_COLLECTION, STATS_FIELD_PROVIDER,
    STATS_FIELD_STATUS, STATS_FIELD_VECTORS_COUNT, STATUS_ACTIVE, STATUS_UNKNOWN,
...
impl PineconeVectorStoreProvider {
    ...
    async fn query_match_results(&self, payload: Value) -> Result<Vec<SearchResult>> {
        let response = self
    ...
    fn collection_dimensions(&self, collection: &str) -> usize {
        self.collections
            .get(collection)
