    ...
    executor
        .execute(
            ...
            &[
                ...
                SqlParam::String(DEFAULT_ORG_ID.to_owned()),
                SqlParam::String("schema-upgrade-project".to_owned()),
                SqlParam::String("/tmp/schema-upgrade-project".to_owned()),
                SqlParam::I64(0),
                SqlParam::I64(0),
            ],
        )
            ...
            executor
                .execute(
                    ...
                    &[
                        ...
                        SqlParam::String("proj-schema-upgrade".to_owned()),
                        SqlParam::String("content".to_owned()),
                        SqlParam::String("hash-obs-malformed".to_owned()),
                        SqlParam::String("[]".to_owned()),
                        SqlParam::String("context".to_owned()),
                        SqlParam::String("{not-valid-json".to_owned()),
                        SqlParam::I64(1),
                        SqlParam::Null,
                    ],
                )
            ...
            executor
                .execute(
                    ...
                    &[
                        ...
                        SqlParam::String("proj-schema-upgrade".to_owned()),
                        SqlParam::String("content".to_owned()),
                        SqlParam::String("hash-obs-bad-tags".to_owned()),
                        SqlParam::String("{bad-tags-json".to_owned()),
                        SqlParam::String("context".to_owned()),
                        SqlParam::String("{}".to_owned()),
                        SqlParam::I64(1),
                        SqlParam::Null,
            ...
            executor
                .execute(
                    ...
                    &[
                        ...
                        SqlParam::String("proj-schema-upgrade".to_owned()),
                        SqlParam::String(session_id.to_string()),
                        SqlParam::String("{bad-topics-json".to_owned()),
                        SqlParam::String("[]".to_owned()),
                        SqlParam::String("[]".to_owned()),
                        SqlParam::String("[]".to_owned()),
                        SqlParam::String("null".to_owned()),
                        SqlParam::I64(1),
                    ],
                )
                .await?;
