...
#[tokio::test]
async fn malformed_observation_metadata_is_rejected() {
...
#[tokio::test]
async fn malformed_session_summary_origin_context_is_rejected() {
    let (memory_repo, executor, _temp_dir) = setup_memory_repo().await;
...
#[tokio::test]
async fn malformed_observation_tags_is_rejected() {
    let (memory_repo, executor, _temp_dir) = setup_memory_repo().await;
...
#[tokio::test]
async fn malformed_session_summary_topics_is_rejected() {
    let (memory_repo, executor, _temp_dir) = setup_memory_repo().await;
