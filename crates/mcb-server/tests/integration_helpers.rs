...
mod tests {
    ...
    fn test_service_detection_logic() {
        ...
        let _milvus = is_milvus_available();
        let _ollama = is_ollama_available();
        let _redis = is_redis_available();
        let _postgres = is_postgres_available();
