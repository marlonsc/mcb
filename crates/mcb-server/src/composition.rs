...
///
/// Used by the Loco MCP initializer and by tests. No manual bootstrap or factory.
///
/// # Errors
///
...
pub fn build_mcp_server_bootstrap(
    ...
    let mcp_services = McpServices {
        ...
        context: resolve_context_service(raw_ctx)?,
        search: resolve_search_service(raw_ctx)?,
        validation: resolve_validation_service(raw_ctx)?,
        memory: resolve_memory_service(raw_ctx)?,
