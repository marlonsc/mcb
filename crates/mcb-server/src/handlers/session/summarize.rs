...
/// Create a session summary from the provided payload and resolved origin context.
async fn create_summary(
    ...
    let project_id = origin_context
        .project_id
        .clone()
        .ok_or_else(|| McpError::invalid_params("project_id is required for summarize", None))?;
