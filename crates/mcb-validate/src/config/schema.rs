...
//!
//! Configuration schema structs for mcb-validate.
//!
//! Pure data shapes (serde-derived) deserialized from the figment provider
//! chain in [`super::file_config`]. Kept separate from the loading logic so
//! each module stays focused and under the file-size cap.
