...
use super::duplicates::validate_duplicate_definitions;
use super::modules::validate_mod_declarations;
use super::tests::validate_missing_test_files;
...
crate::impl_rules_validator_new!(RefactoringValidator, refactoring);
