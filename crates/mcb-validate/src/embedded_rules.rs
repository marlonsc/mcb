...
impl EmbeddedRules {
    ...
    pub fn all_yaml() -> Vec<(&'static str, &'static str)> {
        vec![
            ...
            rule!("clean-architecture/CA016_constants-ssot.yml"),
            rule!("clean-architecture/CA017_di-patterns.yml"),
            rule!("clean-architecture/CA018_no-proxy-wrapper.yml"),
            rule!("clean-architecture/CA019_outer-crate-isolation.yml"),
