...
- _implement a new feature!_ ➡️
  [open an issue to discuss it first, then a pull request](#issues)
...
[the rustlings contributing guide](https://github.com/rust-lang/rustlings/issues/new).
...
You are welcome to open a pull request, but unless it is small and trivial, **please
...
If you need any help with it or face any Git related problems, don't hesitate to ask for
help 🤗
...
- Add the [metadata for your exercise](#exercise-metadata) in the
  `rustlings-macros/info.toml` file.
