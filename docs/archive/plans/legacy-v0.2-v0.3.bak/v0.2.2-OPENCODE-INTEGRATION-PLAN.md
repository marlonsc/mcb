...
| Current | MCB Replacement | Savings |
| --------- | ----------------- | --------- |
| `docs/plans/archive/LEGACY_PLANNING_*.md` documents | MCB project phases | Unified tracking |
...
read("docs/plans/archive/LEGACY_PLANNING_ROADMAP.md")
read("docs/plans/archive/LEGACY_PLANNING_STATE.md")
