...
Creates:
-   docs/plans/archive/LEGACY_PLANNING_*.md document structure
...
Research Phase:
  ...
  -   Reads docs/plans/archive/LEGACY_PLANNING_*.md files manually
...
- **MCB Gaps Report**: `/home/marlonsc/mcb/docs/plans/archive/MCB-COMPREHENSIVE-GAPS.md`
