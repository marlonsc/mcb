...
The intended integration pattern for OpenCode:

```
┌─────────────────────────────────────────────────┐
│  Project: "opencode"                            │
│  ├── Collection: "opencode" (code index)        │
│  ├── Memory: observations linked to project     │
│  └── Sessions: agent sessions with context      │
└─────────────────────────────────────────────────┘
```

**Current State**: Only collection works. Project and memory are broken.
