...
- **Total**: 1,3083+ tests across unit, integration, golden, and E2E
...
First stable release — complete drop-in replacement for Claude-context with 14 languages processors, 6 embedding providers, 6 vector stores, systemd integration, and comprehensive documentation.
