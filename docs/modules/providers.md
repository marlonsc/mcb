...
| ---------- | ------ | ---------- | ------ | ----------- | ---------- |
| EdgeVec | [`edgevec/mod.rs`](../../crates/mcb-providers/src/vector_store/edgevec/mod.rs) | In-process | None | HNSW (M=16, EF=100) | Dev/test, single-instance |
| Milvus | [`milvus/mod.rs`](../../crates/mcb-providers/src/vector_store/milvus/mod.rs) | gRPC | Optional | IVF_FLAT (NLIST=128) | Production cloud |
| Qdrant | [`qdrant/mod.rs`](../../crates/mcb-providers/src/vector_store/qdrant/mod.rs) | HTTP REST | API key | HNSW configurable | Production cloud |
| Pinecone | [`pinecone/mod.rs`](../../crates/mcb-providers/src/vector_store/pinecone/mod.rs) | HTTP REST | API key | Pre-created index | Managed cloud |
