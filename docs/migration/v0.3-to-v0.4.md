...
> **v0.3.0 Migration Note:** Runtime configuration now uses Loco YAML (`config/development.yaml`, `config/test.yaml`). The TOML snippet below is historical planning context.
