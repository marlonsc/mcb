...
>
> **Code examples** below use `DiContainerBuilder` (removed). Current DI: dill Catalog, handles, linkme — see ADR-029 (hexagonal architecture with dill).
...
- ADR-007: Integrated Web Administration Interface - AdminService DI
