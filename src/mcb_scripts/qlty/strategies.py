...
class FixStrategy:
    ...
    subclass states literal text. Declaring them as abstract properties while
    subclasses assigned plain strings made each assignment an incompatible
    override of a property, which is what the type checkers reported.
    """
