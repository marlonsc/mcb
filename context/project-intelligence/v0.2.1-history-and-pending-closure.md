...
- Current project context: `docs/developer/ROADMAP.md`.
...
- Sources: `docs/developer/ROADMAP.md`, `docs/developer/ROADMAP.md`.
...
2. ~~**Run full quality gate for current branch state**~~
   - **DONE**: `cargo check` ✅, `cargo fmt` ✅, `make lint MCB_CI=1` ✅,
     `make test SCOPE=all THREADS=4` ✅ (28 suites), `actionlint` ✅,
...
| `docs/developer/ROADMAP.md` | Session-state snapshot | Yes | Keep synchronized with closure decisions and Beads numbers. |
