...
- Planning docs:
  - `docs/plans/archive/MCB-GAPS-REPORT.md`
  - `docs/plans/archive/MCB-COMPREHENSIVE-GAPS.md`
  - `docs/plans/archive/MCB-VALIDATION-REPORT.md`
  - `docs/plans/OPENCODE-INTEGRATION-PLAN.md`
  - `docs/plans/OPENCODE-MCB-MIGRATION-PLAN.md`
- Release docs:
...
- 2026-02-12: Added closure-audit evidence: 24 plan triage completed and 50 open
  Beads issues scope-tagged.
