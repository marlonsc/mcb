...
- Guide: [Rocket Guide](https://rocket.rs/guide/v0.5)
- API docs: [Rocket API Docs](https://docs.rs/rocket/latest/rocket/)
- Upstream: [Rocket Repo](https://github.com/rwf2/Rocket)
...
- Upstream Rocket: [Rocket Repo](https://github.com/rwf2/Rocket)
- Rocket guide: [Rocket Guide](https://rocket.rs/guide/v0.5)
- Production example (Vaultwarden): [Vaultwarden Main](https://github.com/dani-garcia/vaultwarden/blob/main/src/main.rs)
...
- [Rocket API Docs](https://docs.rs/rocket/latest/rocket/)
- [Rocket Repo](https://github.com/rwf2/Rocket)
