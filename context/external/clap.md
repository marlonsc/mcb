...
- Main docs: [Clap Docs](https://docs.rs/clap/latest/clap/)
- Derive tutorial: [Clap Derive Tutorial](https://docs.rs/clap/latest/clap/_derive/_tutorial/)
- Upstream: [Clap Repo](https://github.com/clap-rs/clap)
...
- Upstream Clap: [Clap Repo](https://github.com/clap-rs/clap)
- Production CLI example (fd): [fd CLI](https://github.com/sharkdp/fd/blob/master/src/cli.rs)
- Production CLI example (ripgrep): [ripgrep Flags](https://github.com/BurntSushi/ripgrep/blob/master/crates/core/flags/defs.rs)
...
- [Clap Repo](https://github.com/clap-rs/clap)
